...
public sealed class BankAccountConfiguration : IEntityTypeConfiguration<BankAccount>
{
    public void Configure(EntityTypeBuilder<BankAccount> builder)
    {
        ...
        builder.Property(a => a.IBAN).HasMaxLength(50).IsRequired(false);
        builder.Property(a => a.AcountNumber).HasMaxLength(50).IsRequired(false);
        builder.Property(a => a.CurrencyId).HasMaxLength(50).IsRequired(true);
        ...
        builder.HasOne(c => c.Currency).WithMany(c => c.BankAcounts).HasForeignKey(c => c.CurrencyId);
