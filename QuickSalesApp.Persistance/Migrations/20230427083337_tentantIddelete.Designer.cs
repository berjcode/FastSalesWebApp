...
namespace QuickSalesApp.Persistance.Migrations
{
    ...
    [Migration("20230427083337_tentantIddelete")]
    partial class tentantIddelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickSalesApp.Domain.AppEntities.MainCompany", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuickSalesApp.Domain.AppEntities.MainRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuickSalesApp.Domain.AppEntities.MainRoleAndRoleRelationShip", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuickSalesApp.Domain.AppEntities.Company", b =>
                {
                    b.HasOne("QuickSalesApp.Domain.AppEntities.MainCompany", "MainCompany")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("QuickSalesApp.Domain.AppEntities.MainRoleAndRoleRelationShip", b =>
                {
                    ...
                    b.HasOne("QuickSalesApp.Domain.AppEntities.Identity.AppRole", "AppRole")
                        .WithMany()
