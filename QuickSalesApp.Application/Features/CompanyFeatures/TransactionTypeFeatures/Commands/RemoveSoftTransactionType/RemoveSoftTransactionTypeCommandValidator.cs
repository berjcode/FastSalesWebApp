...
public sealed class RemoveSoftTransactionTypeCommandValidator : AbstractValidator<RemoveSoftTransactionTypeCommand>
{
    public RemoveSoftTransactionTypeCommandValidator()
    {
