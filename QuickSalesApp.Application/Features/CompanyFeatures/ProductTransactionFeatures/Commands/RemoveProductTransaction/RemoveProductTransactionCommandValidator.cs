...
public sealed class RemoveProductTransactionCommandValidator : AbstractValidator<RemoveProductTransactionCommand>
{
    public RemoveProductTransactionCommandValidator()
    {
